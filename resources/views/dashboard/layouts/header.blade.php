...
<head>
    ...
    <link rel="shortcut icon" href="{{url('/')}}/dashboard/assets/images/logo.png" type="image/png">
    <title>
        پلن مدیریتی مدوس
    </title>
</head>
...
<div class="loader" id="loader">
    ...
    <img src="{{url('/')}}/dashboard/assets/images/logo.png" alt="Meddos future creation">
</div>
<!--Main Navigation-->
<header>
    <!-- Sidebar -->
